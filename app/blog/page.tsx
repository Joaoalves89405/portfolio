...
const page = () => {
	return (
		<div>
			<h1 className='text-[36px] font-bold'>Writings</h1>
			<p>
				Here are some of my writings. All of my writings are available on my{' '}
				<span>
					<a href='https://yafialhakimblog.vercel.app/' className='text-blue-500'>
						blog
					</a>
				</span>
				.
			...
			<div className='mt-8 flex flex-col gap-4'>
				<Writing
					title={'My First Open-Source Contribution: Translating ReactJS Pages to Indonesian Language'}
